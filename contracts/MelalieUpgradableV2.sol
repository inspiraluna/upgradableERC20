 ...
 */
contract MelalieUpgradableV2 is ERC20Upgradeable, OwnableUpgradeable {
     ...
     */
    function initialize(string memory name,string memory symbol, uint256 _supply) initializer public {
